      ...
      <div className="container px-4">
        ...
        >
          <motion.div 
            ...
            whileHover={{ 
              y: -8, 
              boxShadow: "0 15px 30px rgba(0, 240, 255, 0.1)",
              transition: { duration: 0.2 } 
            }}
          >
            <div className="w-14 h-14 bg-neon-blue/10 rounded-xl flex items-center justify-center mb-6">
              <Trophy size={28} className="text-neon-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">Superior Accuracy</h3>
          ...
          >
            ...
            <p className="text-gray-400">We cover 3x more sports and leagues than competitors, giving you more opportunities to find value bets.</p>
          </motion.div>
          ...
          >
            <div className="w-14 h-14 bg-neon-blue/10 rounded-xl flex items-center justify-center mb-6">
              <ExternalLink size={28} className="text-neon-blue" />
            </div>
            <h3 className="text-xl font-semibold mb-3">Value Bet Detection</h3>
            <p className="text-gray-400">Our exclusive AI system identifies mispriced odds that other platforms miss completely.</p>
          </motion.div>
        </motion.div>
      </div>
    </section>
