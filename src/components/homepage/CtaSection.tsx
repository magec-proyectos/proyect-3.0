...
const CtaSection = () => {
  ...
  return (
    <section className="py-20 relative overflow-hidden">
      ...
      <div className="absolute top-10 left-10 w-20 h-20 bg-blue-600/20 rounded-full blur-xl animate-float" />
      <div className="absolute bottom-10 right-10 w-32 h-32 bg-green-600/20 rounded-full blur-xl animate-float" style={{ animationDelay: '1s' }} />
        ...
        <AnimatedCard intensity="moderate">
          ...
          >
            ...
            <motion.div 
              ...
              variants={fadeIn}
            >
              <div className="bg-dark-card/50 backdrop-blur-sm border border-gray-700 rounded-xl p-4 hover:border-blue-600/50 transition-colors duration-300">
                <div className="text-2xl font-bold text-blue-600 mb-1">10K+</div>
                <div className="text-sm text-gray-400">Active Users</div>
              </div>
              
              <div className="bg-dark-card/50 backdrop-blur-sm border border-gray-700 rounded-xl p-4 hover:border-green-600/50 transition-colors duration-300">
